...
/***/ function(module, exports, __webpack_require__) {
	...
	exports["default"] = configuerStore;
	...
	var _reducersReducerJs = __webpack_require__(180);

	var _reducersReducerJs2 = _interopRequireDefault(_reducersReducerJs);

	var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_reduxThunk2["default"])(_redux.createStore);

	function configuerStore(initialStore) {
		var store = createStoreWithMiddleware(_reducersReducerJs2["default"], initialStore);
		return store;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsAction = __webpack_require__(181);

	function counter(state, action) {
		if (state === undefined) state = 0;

		switch (action.type) {
			case _actionsAction.ADD:
				return state + 1;
			case _actionsAction.RED:
				return state - 1;
			default:
				return state;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentAppJs = __webpack_require__(183);

	var _componentAppJs2 = _interopRequireDefault(_componentAppJs);

	var _actionsAction = __webpack_require__(181);

	var Actions = _interopRequireWildcard(_actionsAction);
	...
	exports["default"] = (0, _reactRedux.connect)(mapStateToprops, mapDispatchToProps)(_componentAppJs2["default"]);
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(App, [{
			...
			value: function render() {
				...
				return _react2["default"].createElement(
					...
					_react2["default"].createElement("input", { type: "button", onClick: this.handleClick, value: "++++++++++" }),
					_react2["default"].createElement(
						"button",
						null,
						"submit"
	...
	var Bpp = (function (_React$Component2) {
		_inherits(Bpp, _React$Component2);

		function Bpp() {
			_classCallCheck(this, Bpp);

			_get(Object.getPrototypeOf(Bpp.prototype), "constructor", this).apply(this, arguments);
		}
	...
	var Cpp = (function (_React$Component3) {
		_inherits(Cpp, _React$Component3);

		function Cpp() {
			_classCallCheck(this, Cpp);

			_get(Object.getPrototypeOf(Cpp.prototype), "constructor", this).apply(this, arguments);
		}
		...
		_createClass(Cpp, [{
			...
			value: function render() {
				...
				var ince = _props3.ince;
				var dece = _props3.dece;
				var increment = _props3.increment;
				var decrement = _props3.decrement;
				var counter = _props3.counter;
